...
# Udacity Carnival
Starter project for **Andrea Wooding** for the Udacity [VR Developer Nanodegree](http://udacity.com/vr) program.
...
- [GVR SDK for Unity v1.180.0](https://github.com/googlevr/gvr-unity-sdk/releases/tag/v1.180.0)
